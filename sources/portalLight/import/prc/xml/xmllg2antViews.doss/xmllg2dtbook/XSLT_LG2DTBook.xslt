...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="livre">
        <dtbook version="2005-3" xmlns="http://www.daisy.org/z3986/2005/dtbook/" xml:lang="fr-FR">
            ...
            <book>
               <frontmatter>
									<doctitle><xsl:apply-templates select="ident/tit" mode="doctitle"/></doctitle>
									<docauthor><xsl:apply-templates select="ident/auteur" mode="doctitle"/></docauthor>
 									<xsl:for-each select="ident/dedi|ident/exer | ident/collec | collec | appen/collec">
										 <level1>
                   <xsl:choose>
												 <xsl:when test="name()='collec'"><xsl:attribute name="class">collection</xsl:attribute></xsl:when>
												 <xsl:otherwise><xsl:attribute name="class">dedicace</xsl:attribute></xsl:otherwise>
											 </xsl:choose>
    ...
    <xsl:template match="br" mode="ident">
        ...
        <xsl:template match="b | pbib | sl | cint | ident/collec/pbib | ident/collec/cint" mode="frontmatter">
    ...
    <xsl:template match="ident/info | ident/trad | ident/ref">
...
<!--fin ajout gautier-->
    ...
    <xsl:template match="ident/exer | ident/dedi"/>

    <!-- Informations de l'ident ignorées : pas de correspondance en DTBook -->
    <!--exclusion de  | ident/isbn-->
    <xsl:template match="ident/type | ident/pagetitre | ident/ftit | ident/coned | ident/issn | ident/nbpages"/>
    ...
    <xsl:template match="rp" mode="frontmatter">
        <pagenum id="p{@folio}"><xsl:value-of select="@folio"></xsl:value-of></pagenum>                
    </xsl:template>
    <!-- ******************************************** -->
    ...
    <xsl:template match="livre/pre">
        <xsl:if test="position() = 1">
            <!-- Dans le premier préliminaires, injection du titre et de l'auteur issus de ident en mode doctitle-->            
            <doctitle><xsl:apply-templates select="/livre/ident/tit" mode="doctitle"/></doctitle>
            <docauthor><xsl:apply-templates select="/livre/ident/auteur" mode="doctitle"/></docauthor>
        </xsl:if>
        <level1>
            <xsl:if test="@folio">
                <pagenum id="p{@folio}"><xsl:value-of select="@folio"></xsl:value-of></pagenum>                
            </xsl:if>
            <xsl:for-each select="/livre/ident/dedi | /livre/ident/exer">
    ...
    <xsl:template match="tit | auteur" mode="doctitle">
       <!-- injection du titre et de l'auteur dans les balise doctitle et docauthor : on préservve le balisage interneen mode doctitle -->
    ...
    <xsl:template match="corps/appcrit | corps/part | corps/chap | pre| corps/sect | corps/conclusion | corps/epilogue | corps/annexe | corps/bio | corps/glossaire | corps/genealogie | corps/lexique | corps/historique | corps/notes | corps/remer | corps/biblio | corps/remarque | corps/chrono | corps/table | corps/table_aut | corps/table_noms | corps/table_alpha | corps/sommaire | corps/tdm | corps/index | corps/personnages | corps/horstexte | corps/autre | corps/vol ">
        <level1 class="{name()}">
            <xsl:apply-templates/>
        </level1>
    </xsl:template>

    <xsl:template match="conclusion | epilogue | annexe | bio | glossaire | genealogie | lexique | historique | notes | remer | biblio | remarque | chrono | table | table_aut | table_noms | table_alpha | sommaire | tdm | index | personnages | horstexte | autre | appcrit">
        <level1 class="{name()}">
            <xsl:apply-templates/>
        </level1>
    </xsl:template>
    ...
    <xsl:template match="corps/vol/part | corps/part/pre | corps/part/chap | corps/sect/chap | corps/chap/schap | corps/part/spart | corps/vol/chap ">
        <level2 class="{name()}">
            <xsl:apply-templates/>
        </level2>
    </xsl:template>
    ...
    <xsl:template match="corps/vol/part/chap | corps/part/chap/schap | corps/sect/chap/schap | corps/sect/chap/schap| corps/vol/chap/schap |corps/part/spart/chap">
        <level3 class="{name()}">
            <xsl:apply-templates/>
        </level3>
    </xsl:template>
    ...
    <xsl:template match="corps/col/n | corps/part/n | corps/chap/n | corps/appen/n | corps/sect/n | corps/sect/n">
        <xsl:choose>
            <xsl:when test="local-name(following-sibling::node()[1]) = 'tit'"/>
            <xsl:otherwise>
                <h1>
                    <xsl:apply-templates/>
                </h1>
    ...
    <xsl:template match="corps/vol/tit | corps/part/tit | corps/chap/tit | corps/appen/tit | corps/sect/tit | corps/appen/sect/tit | corps/vol/tit ">
       <h1 class="{local-name(..)}tit">
            <xsl:if test="local-name(preceding-sibling::node()[1]) = 'n'">
    ...
    <!-- level2 : on ignore les numéros quand on les rencontre avant un titre : ils seront traités avec les titres -->
    <xsl:template match="corps/vol/part/n | corps/part/chap/n   | corps/part/pre/n | corps/part/spart/n | corps/chap/schap/n | corps/vol/chap/n | corps/sect/chap/n ">
        <xsl:choose>
            <xsl:when test="local-name(following-sibling::node()[1]) = 'tit'"/>
            <xsl:otherwise>
                <h2>
    ...
    <xsl:template match="corps/vol/part/tit | corps/part/chap/tit | corps/part/pre/tit | corps/sect/chap/tit | corps/vol/chap/tit |corps/chap/schap/tit">
    ...
    <xsl:template match="corps/vol/part/chap/n | corps/sect/part/chap/n |corps/sect/chap/schap/n | corps/part/spart/chap/n  | corps/part/chap/schap/n | corps/vol/chap/schap/n  ">
            <xsl:choose>
            <xsl:when test="local-name(following-sibling::node()[1]) = 'tit'"/>
            <xsl:otherwise>
        ...
        <xsl:template match="corps/vol/part/chap/tit | corps/sect/part/chap/tit |corps/sect/chap/schap/tit | corps/part/spart/chap/tit  | corps/part/chap/schap/tit | corps/vol/chap/schap/tit ">
        <h3 class="{local-name(..)}tit">
            <xsl:if test="local-name(preceding-sibling::node()[1]) = 'n'">
                <xsl:value-of select="preceding-sibling::node()[1]"/>
                <xsl:text> </xsl:text>
    ...
    <xsl:template match="appen/tit | conclusion/tit | epilogue/tit | annexe/tit | bio/tit | glossaire/tit | genealogie/tit | lexique/tit | historique/tit | notes/tit | remer/tit | biblio/tit | remarque/tit | chrono/tit | table/tit | table_aut/tit | table_noms/tit | table_alpha/tit | sommaire/tit | tdm/tit | index/tit | personnages/tit | horstexte/tit | autre/tit | appcrit/tit">
        <h1 class="{name()}">
            <xsl:apply-templates/>
        </h1>
    </xsl:template>

    <xsl:template match="appen/n | conclusion/n | epilogue/n | annexe/n | bio/n | glossaire/n | genealogie/n | lexique/n | historique/n | notes/n | remer/n | biblio/n | remarque/n | chrono/n | table/n | table_aut/n | table_noms/n | table_alpha/n | sommaire/n | tdm/n | index/n | personnages/n | horstexte/n | autre/n | appcrit/n">
        <h1 class="{name()}">
            <xsl:apply-templates/>
        </h1>
    </xsl:template>
    ...
    <xsl:template match="appcrit">
        <level1 class="appcrit">
            <xsl:apply-templates/>                
        </level1>
    </xsl:template>   
    <!-- ******************************************** -->
        <!-- traitement de la super structure des appendices -->
    ...
    <xsl:template match="p">
        <xsl:element name="p">
            ...
            <!-- avant d'injeter le contenu du paragraphe, on recherche la présence d'une lettrine juste avant--> 
            <xsl:if test="local-name(preceding-sibling::node()[1]) = 'let'">  
               <!--  si ce paragraphe est précédé immédiatement par une balise lettrine, l'injecter ici au début du paragraphe, mode lettrine -->
                 <xsl:value-of select="preceding-sibling::node()[1]"/>
            </xsl:if> 
            <xsl:apply-templates/>
        </xsl:element>        
...
<!-- conservation du nom vers author (vaut pour d'autres cas que SMS) -->
    ...
    <xsl:template match="i | mev">
        <em><xsl:apply-templates/></em>
    </xsl:template>
    <xsl:template match="b | pbib | sl | cint | ident/collec/pbib | ident/collec/cint">
    ...
    <xsl:template match="sep">
       <!-- Séparateur, remplacés par étoiles-->
        <p><xsl:text>***</xsl:text>
            <!--garder le type en attribut Pas de possibilité de mettre des br en dehors des paragraphes, donc report du br dans un p 
            <br title="{@type}"/>-->
        </p>
    </xsl:template>
    ...
    <xsl:template match="rp">
        ...
        <xsl:choose>
            <xsl:when test="(preceding::node()/@folio/. = $folio) or (ancestor::node()/@folio/. = $folio)" />
            <xsl:otherwise>
                <pagenum id="p{@folio}"><xsl:value-of select="@folio"></xsl:value-of></pagenum>                                
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template match="apnb">
        <!--  appel de note -->
        <noteref class="footnote" idref="#{@id}"><xsl:value-of select="substring-after(@id,'ntb-')"/></noteref>        
    </xsl:template>
    ...
    <!-- Ajout des notes de type apnf (GC)-->
    ...
    <!-- Traitement des noeuds texte --> 
		...
		<xsl:template match="text()" mode="frontmatter"><xsl:copy/></xsl:template>
		<xsl:template match="text()" mode="doctitle"><xsl:copy/></xsl:template>
    
    <!-- ******************************************************************** -->
    <!-- Voitures balais : signaler toute balise non traitée dans chaque mode -->
    <xsl:template match="*" mode="frontmatter">
        <xsl:message>Elément XML non traduit [<xsl:value-of select="local-name()"/>] en mode frontmatter</xsl:message>
    <!-- Voitures balais sans h& (donne un commentaire dans scenari): signaler toute balise non traitée dans chaque mode -->
    ...
    <xsl:template match="*" mode="ident">
        <xsl:message>Elément XML non traduit [<xsl:value-of select="local-name()"/>] en mode ident</xsl:message>
   <!-- Voitures balais sans h& (donne un commentaire dans scenari): signaler toute balise non traitée dans chaque mode -->
        <xsl:element name="{local-name()}">
            <xsl:for-each select="@*">
                <xsl:attribute name="{local-name()}">
    ...
    <xsl:template match="*" mode="doctitle">
        <xsl:message>Elément XML non traduit [<xsl:value-of select="local-name()"/>] en mode doctitle</xsl:message>
       <!-- Voitures balais sans h& (donne un commentaire dans scenari): signaler toute balise non traitée dans chaque mode -->
        <xsl:element name="{local-name()}">
            <xsl:for-each select="@*">
                <xsl:attribute name="{local-name()}">
    ...
    <xsl:template match="*" mode="lettrine">
        <xsl:message>Elément XML non traduit [<xsl:value-of select="local-name()"/>] en mode lettrine</xsl:message>
   <!-- Voitures balais sans h& (donne un commentaire dans scenari): signaler toute balise non traitée dans chaque mode -->
        <xsl:element name="{local-name()}">
            <xsl:for-each select="@*">
                <xsl:attribute name="{local-name()}">
    ...
    <xsl:template match="*">
        <xsl:message>Elément XML non traduit [<xsl:value-of select="local-name()"/>]</xsl:message>
   <!-- Voitures balais sans h& (donne un commentaire dans scenari): signaler toute balise non traitée dans chaque mode -->
        <xsl:element name="{local-name()}">
            <xsl:for-each select="@*">
                <xsl:attribute name="{local-name()}">
